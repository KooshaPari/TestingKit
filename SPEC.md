# TestingKit - Specification

## Problem

`TestingKit` addresses a specific need in the Phenotype fleet: phenotype-org testing domain sdk: bdd, property-based, fuzzing, contract. Without a canonical implementation, downstream consumers must reinvent the same primitives, leading to fragmentation and divergent behavior across the fleet.

## Solution

`TestingKit` provides a single, well-tested, well-documented implementation of this capability. The package ships with:
- A stable public API
